...
exports.createRental = async (req, res) => {
    try {
        ...
        // Decrement available quantity by requested amount
...
exports.returnTool = async (req, res) => {
    try {
        ...
        // Increment available quantity by rented quantity
...
exports.getRentals = async (req, res) => {
    try {
        const rentals = await Rental.find().populate('itemId', 'name image costPerDay').sort({ createdAt: -1 });
        res.json(rentals);
    } catch (error) {
