...
│   │   │   ├── AddToolModal.jsx     ← [NEW] Modal for adding tools
│   │   │   ├── Features.jsx
│   │   │   ├── Footer.jsx
│   │   │   ├── HeroSlider.jsx
│   │   │   ├── LoginModal.jsx       ← [MODIFIED] Redirects to /admin/dashboard
│   │   │   ├── Navbar.jsx
│   │   │   ├── ProblemContext.jsx
│   │   │   └── ToolCard.jsx         ← [NEW] Inventory card with status badges
│   │   │
│   │   ├── context/
│   │   │   └── AuthContext.jsx      ← Global auth state (user, login, logout)
│   │   │
│   │   ├── pages/
│   │   │   ├── AdminDashboard.jsx   ← [NEW] Protected admin inventory page
│   │   │   └── LandingPage.jsx      ← Public landing page
│   │   │
│   │   ├── services/
│   │   │   ├── api.js               ← Base fetchWithAuth helper
│   │   │   └── toolService.js       ← [NEW] fetchTools / createTool API calls
│   │   │
│   │   ├── App.jsx                  ← [MODIFIED] BrowserRouter + Routes
│   │   ├── App.css
...
│   │   └── toolController.js        ← [NEW] getTools, createTool
│   │
│   ├── middleware/
│   │   └── authMiddleware.js        ← JWT protect() middleware
│   │
│   ├── models/
│   │   ├── User.js                  ← Admin user schema (bcrypt + jwt)
│   │   └── Tool.js                  ← [NEW] Tool inventory schema
│   │
│   ├── routes/
│   │   ├── authRoutes.js            ← POST /api/auth/login|register
│   │   └── toolRoutes.js            ← [NEW] GET|POST /api/tools
│   │
│   ├── services/
│   ├── .env                         ← [NEW] PORT, MONGO_URI, JWT_SECRET
│   ├── createAdmin.js               ← Admin user seeding script
│   ├── package.json
│   └── server.js                    ← [MODIFIED] Express app entry point
│
└── README.md
